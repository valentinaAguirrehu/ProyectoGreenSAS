...
<body>
    <div class="content"> 
        ...
        <h3>Detalles de temporales GREEN S.A.S</h3>

        <h1>Datos personales</h1>
        <table class="info-table" border="1">
            <tr><th>Nombre Completo</th>
                <td><%= mostrarCampo(persona.getNombres())%> <%= mostrarCampo(persona.getApellidos())%></td>
            </tr>
            <tr><th>Sexo</th>
                <td><%= mostrarCampo(new GeneroPersona(persona.getSexo()).toString())%></td>
            </tr>
            <tr><th>Fecha de retiro</th>
                <td><%= mostrarCampo(informacionLaboral.getFechaRetiro())%></td>
            </tr>
            <tr><th>Documento de identidad</th>
                <td><%= mostrarCampo(persona.getTipoDocumento())%></td>
            </tr>
            <tr><th>Número del documento</th>
                <td><%= mostrarCampo(persona.getIdentificacion())%></td>
            </tr>
        ...
        <table class="info-table">
            <tr><th>Número de placa:</th>
                <td><%= mostrarCampo(vehiculo.getNumeroPlacaVehiculo())%></td>
            </tr>
            <tr><th>Tipo medio de transporte</th>
                <td><%= mostrarCampo(vehiculo.getTipoVehiculo())%></td>
            </tr>
            <tr><th>Modelo:</th>
                <td><%= mostrarCampo(vehiculo.getModeloVehiculo())%></td>
            </tr>
            <tr><th>Línea:</th>
                <td><%= mostrarCampo(vehiculo.getLinea())%></td>
            </tr>
            <tr><th>Marca:</th>
                <td><%= mostrarCampo(vehiculo.getMarca())%></td>
            </tr>
            <tr><th>Color:</th>
                <td><%= mostrarCampo(vehiculo.getColor())%></td>
            </tr>
            <tr><th>Cilindraje:</th>
                <td><%= mostrarCampo(vehiculo.getCilindraje())%></td>
            </tr>
            <tr><th>Restricciones del conductor</th>
                <td><%= mostrarCampo(vehiculo.getRestricciones())%></td>
            </tr>
            <tr><th>Titular Tarjeta de Propiedad</th>
                <td><%= mostrarCampo(vehiculo.getTitularTrjPro())%></td>
            </tr>
            <tr><th>Número de la tarjeta de propiedad</th>
                <td><%= mostrarCampo(vehiculo.getNumLicenciaTransito())%></td>
            </tr>
            <tr><th>Fecha de expedición tarjeta de propiedad</th>
                <td><%= mostrarCampo(vehiculo.getFechaExpLicenciaTransito())%></td>
            </tr>
        </table>
        ...
        <table class="info-table">
            <tr><th>Estado</th>
                <td><%= mostrarCampo(vehiculo.getEstadoV())%></td>
            </tr>
            <tr><th>Fecha de expedición de la licencia de conducción</th>
                <td><%= mostrarCampo(vehiculo.getFechaExpConduccion())%></td>
            </tr>
            <tr><th>Fecha de vencimiento de la licencia de conducción</th>
                <td><%= mostrarCampo(vehiculo.getFechaVencimiento())%></td>
            </tr>
            <tr><th>Número de la licencia de conducción</th>
                <td><%= mostrarCampo(vehiculo.getNumLicenciaConduccion())%></td>
            </tr>
        </table>
