...
//    persona.setTipo("C");
    ...
    switch (accion) {
       ...
       // Redirige al formulario manteniéndose en la vista
            response.sendRedirect("infLaboralAFormulario.jsp?identificacion=" + vehiculo.getIdentificacion() + "&accion=Modificar");
...
if ("Adicionar".equals(accion)) {
    ...
    response.sendRedirect("infLaboralAFormulario.jsp?identificacion=" + identificacionParaRedirigir);
