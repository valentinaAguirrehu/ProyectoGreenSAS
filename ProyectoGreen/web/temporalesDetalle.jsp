...
<body>
    <div class="content"> 
        ...
        <h3>Detalles del Colaborador Temporal</h3>
        ...
        <table class="info-table">
            ...
            <tr><th>Fecha de Nacimiento</th><td><%= persona.getFechaNacimiento()%></td>
            </tr><tr><th>Edad</th><td><%= edad >= 0 ? edad + " años" : "Fecha inválida"%></td></tr>
        ...
        <table class="info-table">
            ...
            <tr><th>Fecha devexpedición licencia de conducción</th><td><%= persona.getFechaExpConduccion()%></td></tr>
            <tr><th>Fecha de vencimiento</th><td><%= persona.getFechaVencimiento()%></td></tr>
            <tr><th>Fecha licencia de conducción</th><td><%= persona.getNumLicenciaConduccion()%></td></tr>
        </table>
        <% }%>
