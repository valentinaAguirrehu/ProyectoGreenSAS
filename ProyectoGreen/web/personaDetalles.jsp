...
<table class="info-table">
    ...
    <tr><th>Talla buzo</th><td><%= persona.getTallaBuzo()%></td></tr>
    <tr><th>Talla chaqueta</th><td><%= persona.getTallaChaqueta()%></td></tr>
    <tr><th>Talla pantalon</th><td><%= persona.getTallaPantalon()%></td></tr>
    <tr><th>Talla Overol</th><td><%= persona.getTallaOverol()%></td></tr>
    <tr><th>Talla guantes</th><td><%= persona.getTallaGuantes()%></td></tr>
    <tr><th>Talla calzado</th><td><%= persona.getTallaCalzado()%></td></tr>
</table>
<p>
