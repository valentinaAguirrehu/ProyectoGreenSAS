...
<div class="content">
  ...
  <tbody>
    <!-- SG‑SST y SGA -->
    <tr>
      <td>Inducción y reinducción SG-SST - acta de compromiso de pausas activas y actores viales</td>
      <td>
    ...
    <!-- Otros documentos -->
    <tr>
      <td>Entrega de recomendaciones médicas</td>
      <td>
        <button class="ver-btn"
    ...
    <tr>
      <td>Actas de reubicación de cargo (si aplica)</td>
      <td>
        <button class="ver-btn"
