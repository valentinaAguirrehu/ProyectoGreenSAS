...
<%
    ...
    switch (tipo) {
        ...
        case "CTotros":
            ...
            break;
        case "TDotros":
            titulo = "TRATAMIENTO Y AUTORIZACIÓN DE DATOS PERSONALES Y AUTORIZACIÓN DE EXÁMENES Y REQUISAS";
            break;
        case "PRotros":
        ...
        case "SGRILAFTotros":
            ...
            break;
        case "SGHotros":
            titulo = "INDUCCIÓN GESTIÓN HUMANA  E INDUCCIÓN AL CARGO ";
            break;
        ...
        case "EntregaRecomendacionesMedicas":
            titulo = "ENTREGA DE RECOMENDACIONES MÉDICAS";
            break;
        case "ECSdigital":
