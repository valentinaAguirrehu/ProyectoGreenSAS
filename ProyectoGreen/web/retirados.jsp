...
<%
    String lista = "";
    List<Retirados> datos = Retirados.getListaEnObjetos(null, null); // Ya filtra por tipo 'R'

    for (Retirados retirado : datos) {
        String idPersona = retirado.getIdPersona(); // Obtener solo el ID

        // Consultar la información de la persona usando su ID
        Persona persona = new Persona(idPersona);

        if (persona != null && persona.getIdentificacion() != null) { // Verificar que la persona exista
            lista += "<tr>";
