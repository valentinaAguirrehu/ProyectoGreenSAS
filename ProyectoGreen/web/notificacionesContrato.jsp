    ...
    try {
        ...
        while (rs.next()) {
            ...
            try {
                ...
                // Guardar en historialCorreos
                String insertHistorial = "INSERT INTO historialCorreos (destinatario, asunto, mensaje, fechaEnvio) VALUES (?, ?, ?, NOW())";
                PreparedStatement insertStmt = conn.prepareStatement(insertHistorial);
                insertStmt.setString(1, email);
                insertStmt.setString(2, asunto);
                insertStmt.setString(3, cuerpoCorreo);
        ...
        // Ahora, vamos a obtener los correos de administradores activos
        ...
        while (adminRs.next()) {
            ...
            try {
                ...
                rs.beforeFirst(); // Reinicia el ResultSet
                ...
                while (rs.next()) {
                    ...
                    // Guardar en historialCorreos
                    String insertHistorialAdmin = "INSERT INTO historialCorreos (destinatario, asunto, mensaje, fechaEnvio) VALUES (?, ?, ?, NOW())";
                    PreparedStatement insertAdminStmt = conn.prepareStatement(insertHistorialAdmin);
                    insertAdminStmt.setString(1, correoAdmin);
                    insertAdminStmt.setString(2, asuntoAdmin);
                    insertAdminStmt.setString(3, cuerpoAdmin);
