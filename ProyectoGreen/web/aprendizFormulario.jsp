...
<form name="formulario" method="post" action="aprendizActualizar.jsp">
    ...
    <table border="0">
        <tr>
            <th>Fecha ingreso etapa lectiva</th>
            <td><input type="text" name="fechaIngresoEtapaLectiva" value="<%= persona.getFechaEtapaLectiva()%>" size="50" maxlength="50"></td>
        </tr>
        <tr>
            <th>Fecha ingreso etapa productiva</th>
            <td><input type="text" name="fechaIngresoEtapaProductiva" value="<%= persona.getFechaEtapaProductiva()%>" size="50" maxlength="50"></td>
        </tr>
         <tr>
            <th>Fecha retiro</th>
            <td><input type="text" name="fechaRetiro" value="<%= persona.getFechaRetiro()%>" size="50" maxlength="50"></td>
        </tr>
        ...
        <td>
         ...
         <tr>
            ...
            <td><input type="text" name="centro de costos" value="<%= persona.getCentroCostos()%>" size="50" maxlength="50"></td>
        </tr>
         <tr>
        ...
        <tr>
           ...
           <tr>
            <th>Tipo de cargo</th>
            <td><input type="text" name="salario" value="<%= persona.getTipoCargo()%>" size="50" maxlength="50"></td>
        </tr>
    </table>
