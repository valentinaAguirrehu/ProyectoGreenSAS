 ...
 * @author Mary
 */
public class EstadoV {
    
    private String codigo;

    public EstadoV(String codigo) {
        this.codigo = codigo;
    }
    ...
    public String getOpcion(){
        String opcion=null;
        switch(codigo){
            case "A": opcion="Activo"; break;
            case "I": opcion="Inactivo"; break;
            case "S": opcion="Suspendido"; break;
   ...
   public String getSelectEstadoV(String nombreCampo) {
    ...
    html.append(getOption("A", "Activo", valorSeleccionado));
    html.append(getOption("I", "Inactivo", valorSeleccionado));
    html.append(getOption("S", "Suspendido", valorSeleccionado));
