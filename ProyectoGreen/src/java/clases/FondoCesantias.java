...
public class FondoCesantias {
    ...
    public FondoCesantias(String codigo) {
        this.codigo = codigo;
    }
   ...
   public String getSelectFondoCesantias(String nombreCampo) {
    ...
    html.append(getOption("V", "Pörvenir", valorSeleccionado));
    html.append(getOption("P", "Proteccion", valorSeleccionado));
    html.append(getOption("N", "Fondo nacional del ahorro", valorSeleccionado));
