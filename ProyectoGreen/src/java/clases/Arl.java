...
public class Arl {
   ...
   public String getSelectArl(String nombreCampo) {
    ...
    html.append(getOption("C", "Colmena", valorSeleccionado));
    html.append(getOption("P", "Positiva", valorSeleccionado));
