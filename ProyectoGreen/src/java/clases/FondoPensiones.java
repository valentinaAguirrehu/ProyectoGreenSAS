...
public class FondoPensiones {
    ...
    public FondoPensiones(String codigo) {
        this.codigo = codigo;
    }
   ...
   public String getSelectFondoPensiones(String nombreCampo) {
    ...
    html.append(getOption("V", "Porvenir", valorSeleccionado));
    html.append(getOption("P", "Proteccion", valorSeleccionado));
    html.append(getOption("C", "Colpensiones", valorSeleccionado));
